...
@CucumberOptions(features = "src\\test\\resources\\AssessmentsFeatures\\QuizSubmission.feature",
glue = {"AssessmentsStepdef","Hooks"},
plugin= {"pretty","com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"},
monochrome = true,
tags = "@AssessmentCenterGroup",
dryRun = false)
public class QuizSubmissionRunner extends AbstractTestNGCucumberTests {
