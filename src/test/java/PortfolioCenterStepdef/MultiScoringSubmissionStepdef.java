...
public class MultiScoringSubmissionStepdef extends ActionType{
	...
	@Then("Enter the Score and submit the Score")
	public void enter_the_score_and_submit_the_score() throws InvalidFormatException, IOException {
		MultiScoring.enter_the_score_and_submit_the_score();
	}
