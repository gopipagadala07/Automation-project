...
@CucumberOptions(
		features = {"src\\test\\resources\\Feature\\Remove_Examataker_from_a_Timeslot.feature"},
...
public class Remove_ExamTaker_from_TimeslotRunner extends AbstractTestNGCucumberTests
{
String testcasename;  // 
