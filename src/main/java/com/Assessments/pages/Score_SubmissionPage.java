...
public class Score_SubmissionPage extends ActionType
{
	...
	@FindBy(how=How.XPATH,using="(//mat-icon[text()='close'])[1]/..")private WebElement closeIcon;
	@FindBy(how=How.XPATH,using="(//mat-icon[text()='close'])[1]/..")private WebElement NextActivity;
